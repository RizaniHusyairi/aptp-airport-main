                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Manajemen Sewa</h3>
                                <p class="text-subtitle text-muted">Lihat data pengajuan sewa.</p>
                            </div>
                    ...
                    <section class="section">
                        <div class="card">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="card-title">Daftar Pengajuan Sewa</h5>
                                @notadmin
                                @notstaff
                                    <a href="{{ route('sewa.create') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Tambah Pengajuan</a>
                                @endnotstaff
                                @endnotadmin
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-sewa">
                                        <thead>
                                            <tr>
                                                ...
                                                @forelse ($rentals as $index => $rental)
                                                    <tr data-id="{{ $index + 1 }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                <form class="col">
                                                                    <a href="{{ asset('uploads/documents/rental/' . basename($rental->documents)) }}" class="btn btn-sm btn-info text-white btn-tooltip" data-bs-toggle="tooltip" title="Lihat Detail" target="_blank"><i class="bi bi-eye"></i></a>
                                                                </form>
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr data-id="">
                                                        ...
                                                        <div class="row g-1">
                                                            ...
                                                            <a href="{{ route('staffSewa.show', $rental->id) }}" class="btn btn-sm btn-primary text-white btn-tooltip" data-bs-toggle="tooltip" title="Lihat Detail">
                                                                <i class="bi bi-eye"></i>
                                                            </a>
                                                            </div>
                                                        </div>
...
@section('scripts_admin')
    ...
    <script src="{{ asset('assetsv2/compiled/js/staff-sewa.js') }}"></script>
@endsection