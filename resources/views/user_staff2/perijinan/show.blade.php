                        ...
                        <div class="col-12">
                            ...
                            @if ($license->documents)
                                <div class="d-flex flex-wrap">
                                    ...
                                    @elseif(is_string($license->documents))
                                        <a href="{{ asset('uploads/' . $license->documents) }}" target="_blank" class="doc-preview-item">
                                            <i class="bi bi-file-earmark-text"></i>
                                            <span>{{ basename($license->documents) }}</span>
                                        </a>
                                    @endif
                                </div>
                            @else
