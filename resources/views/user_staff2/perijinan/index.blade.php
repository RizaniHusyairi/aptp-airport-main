                                                ...
                                                @forelse ($licenses as $index => $license)
                                                    <tr data-id="{{ $index + 1 }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                <form class="col">
                                                                    <a href="{{ asset('uploads/documents/license/' . basename($license->documents)) }}" class="btn btn-sm btn-info text-white btn-tooltip" data-bs-toggle="tooltip" title="Lihat Detail" target="_blank"><i class="bi bi-eye"></i></a>
                                                                </form>
