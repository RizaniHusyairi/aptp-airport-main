                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                <p class="text-subtitle text-muted">Lihat pengajuan tenant untuk staff.</p>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-tenant">
                                        <thead>
                                            <tr>
                                                    ...
                                                    <tr data-id="{{ $index + 1 }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <a href="{{ asset('uploads/documents/tenant/' . basename($tenant->documents)) }}" class="me-1 btn btn-sm btn-info text-white btn-tooltip" data-bs-toggle="tooltip" title="Lihat Detail" target="_blank"><i class="bi bi-eye"></i></a>
...
@section('scripts_admin')
    ...
    <script src="{{ asset('assetsv2/compiled/js/staff-tenant.js') }}"></script>
@endsection
