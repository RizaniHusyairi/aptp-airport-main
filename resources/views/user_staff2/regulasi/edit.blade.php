    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Surat</h3>
                <p class="text-subtitle text-muted">Formulir untuk Mengubah Surat</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <x-breadcrumb2 :items="[
                                ['label' => 'Menu', 'url' => route('profile')],
                                ['label' => 'Regulasi', 'url' => route('letters.staff.index')],
                                ['label' => 'Edit Surat', 'active' => true],
                            ]" />        
            </div>
        </div>
    </div>
...
<section class="section">
    <div class="card">
        <div class="card-header">
            ...
            <h5 class="card-title">Formulir Edit surat</h5>
        </div>
        <div class="card-body">
            <form id="form-surat" method="POST" action="{{ route('letters.staff.update', $letter) }}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        @enderror
                        <small class="form-text text-muted">Unggah dokumen dalam format PDF.</small> <br>
