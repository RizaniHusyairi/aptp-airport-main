...
@section('title', 'Tambah Dokumen Berkala')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah Dokumen Informasi Berkala</h3>
...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('staff.periodic-documents.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
