            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between bg-transparent">
                  <h4 class="card-title">Daftar Sewa Kendaraan Roda Empat (Micro Bus)</h4>
                  @notadmin
                    @notstaff
                    
                      <a href='{{ route("sewa.create", ['type' => 'bus']) }}' class="btn btn-success btn-sm">+ Tambah Pengajuan</a>
                    @endnotstaff
                  @endnotadmin
                </div>
                <div class="card-body">
                    ...
                    @notadmin
                      @notstaff
                        <tbody>
                          ...
                          @empty
                            <tr>
                              <td colspan="4" class="text-center">Belum ada pengajuan sewa Kendaraan Roda Empat (Micro Bus)</td>
                            </tr>
                          @endforelse
                        </tbody>
                      @endnotstaff
