            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between bg-transparent">
                  ...
                  @notadmin
                    @notstaff
                      <a href='{{ route("sewa.create",['type' => 'xray_kargo']) }}' class="btn btn-success btn-sm">+ Tambah Pengajuan</a>
                    @endnotstaff
                  @endnotadmin
                </div>
                <div class="card-body">
                                ...
                                @if ($rental->documents)
                                  <div class="row">
                                    ...
                                    @if ($rental->submission_status == 'diajukan')
                                      <form class="col" action="{{ route('sewa.destroy', ['type' => 'xray_kargo', 'id'=>$rental->id]) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pengajuan ini?')">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <td>
                              <div class="row g-1">
                                <div class="col-12 mb-1">
                                  <a href="{{ route('staffSewa.show', ['type' => 'xray_kargo', 'id'=>$rental->id]) }}" class="btn btn-sm btn-primary w-100">
                                    Lihat
                                  </a>
                                </div>
