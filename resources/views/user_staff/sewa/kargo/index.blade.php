...
@section('title')
  Pengajuan Sewa Xray Kargo
@endsection

@section('content')
  @component('components.breadcrumb')
    @slot('li_1') Sewa Xray Kargo @endslot
    @slot('title') Pengajuan Sewa Xray Kargo @endslot
  @endcomponent
  @if(session('success'))
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between bg-transparent">
                  <h4 class="card-title">Daftar Sewa Xray Kargo</h4>
                  @notadmin
                    @notstaff
                    ...
                    @notadmin
                      @notstaff
                        <tbody>
                          ...
                          @empty
                            <tr>
                              <td colspan="4" class="text-center">Belum ada pengajuan Sewa Xray Kargo</td>
                            </tr>
                          @endforelse
                        </tbody>
                      @endnotstaff
