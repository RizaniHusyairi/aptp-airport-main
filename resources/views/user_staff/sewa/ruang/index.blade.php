...
@section('title')
  Pengajuan Sewa Ruang
@endsection

@section('content')
  @component('components.breadcrumb')
    @slot('li_1') Sewa Ruang @endslot
    @slot('title') Pengajuan Sewa Ruang @endslot
  @endcomponent
  @if(session('success'))
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between bg-transparent">
                  <h4 class="card-title">Daftar Sewa Ruang</h4>
                  @notadmin
                    @notstaff
                    
                      <a href='{{ route("sewa.create", ['type' => 'ruang']) }}' class="btn btn-success btn-sm">+ Tambah Pengajuan</a>
                    @endnotstaff
                  @endnotadmin
                </div>
                <div class="card-body">
                    ...
                    @notadmin
                      @notstaff
                        <tbody>
                          ...
                          @empty
                            <tr>
                              <td colspan="4" class="text-center">Belum ada pengajuan sewa Ruang</td>
                            </tr>
                          @endforelse
                        </tbody>
                      @endnotstaff
