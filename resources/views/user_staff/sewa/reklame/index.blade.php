...
@section('title')
  Pengajuan Sewa Penempatan Reklame
@endsection

@section('content')
  @component('components.breadcrumb')
    @slot('li_1') Sewa Penempatan Reklame @endslot
    @slot('title') Pengajuan Sewa Penempatan Reklame @endslot
  @endcomponent
  @if(session('success'))
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between bg-transparent">
                  <h4 class="card-title">Daftar Sewa Penempatan Reklame</h4>
                  @notadmin
                    @notstaff
                    
                      <a href='{{ route("sewa.create", ['type' => 'reklame']) }}' class="btn btn-success btn-sm">+ Tambah Pengajuan</a>
                    @endnotstaff
                  @endnotadmin
                </div>
                <div class="card-body">
                    ...
                    @notadmin
                      @notstaff
                        <tbody>
                          ...
                          @empty
                            <tr>
                              <td colspan="4" class="text-center">Belum ada pengajuan sewa Penempatan Reklame</td>
                            </tr>
                          @endforelse
                        </tbody>
                      @endnotstaff
