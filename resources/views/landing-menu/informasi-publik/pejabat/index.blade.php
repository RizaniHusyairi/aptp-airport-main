...
@section('content')
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="row card official-card card-pejabat">
                        <img src="/assets/img/pejabat/maeka.JPG" class="card-img-pejabat p-0 col-lg-4" alt="Maeka Rindra Hariyanto" loading="lazy">
                ...
                <div class="swiper-slide">
                    <div class="card official-card row card-pejabat">
                        <img src="/assets/img/pejabat/zaldi.JPG" class="card-img-pejabat p-0 col-lg-4" alt="Zaldi Ardian" loading="lazy">
                ...
                <div class="swiper-slide">
                    <div class="card official-card row card-pejabat">
                        <img src="/assets/img/pejabat/Ikhsan.jpg" class="card-img-pejabat p-0 col-lg-4" alt="Mochamad Ikhsan Fadilah" loading="lazy">
                        <div class="card-body col-lg-8">
                ...
                <div class="swiper-slide">
                    <div class="card official-card row card-pejabat">
                        <img src="/assets/img/pejabat/denny2.JPG" class="card-img-pejabat p-0 col-lg-4" alt="Denny Armanto" loading="lazy">
                        <div class="card-body col-lg-8">
                            <h5 class="card-title">Denny Armanto, S.E, M.A</h5>
                            <p class="card-text">Kepala Seksi Pelayanan dan Kerjasama</p>
                            <button class="btn btn-pejabat read-more" data-target="#profile-denny">Baca Profil Selengkapnya</button>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="card official-card row card-pejabat">
                        <img src="/assets/img/pejabat/murdoko.JPG" class="card-img-pejabat p-0 col-lg-4" alt="Murdoko" loading="lazy">
                        <div class="card-body col-lg-8">
  ...
  <!-- Popup Container -->
    ...
    <div id="profile-denny" class="hidden-profile">
    ...
    <div id="profile-murdoko" class="hidden-profile">
        <p><strong>Riwayat Jabatan:</strong> Kepala Seksi Teknik dan Keamanan (2019–2023), kini menangani Keamanan Penerbangan.</p>
...
@push('page-styles')
  <link href="{{ asset('assets/css/pejabat.css') }}" rel="stylesheet">
@endpush

@push('page-scripts')
  <script src="{{ asset('assets/js/pejabat.js') }}"></script>
@endpush