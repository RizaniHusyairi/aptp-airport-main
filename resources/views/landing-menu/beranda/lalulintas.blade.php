...
@section('content')
<section id="traffic" class="section light-background">
      ...
      <div class="container php-email-form">
        ...
        <div class="text-center mt-4" data-aos="fade-up" data-aos-delay="100">
          <a href="assets_landing/pdf/lalu-lintas-angkutan-udara-2025.pdf" class="btn btn-primary" download>Unduh Laporan (PDF)</a>
        </div>
      </div>
    </section>
    @endsection
