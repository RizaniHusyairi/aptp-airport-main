                            ...
                            labels: {
                                ...
                                formatter: function (val) {
                                    ...
                                    if (realIndex !== -1 && globalChartData.dates_event1) {
                                        return [val, globalChartData.dates_event1[realIndex]];
                                    }
                                    return val;
                                }
                            },
                        ...
                        annotations: {
                            ...
                            xaxis: [
                                // 1. PERIODE ARUS MUDIK (H-7 s.d H-1)
                                {
                                    ...
                                    x2: globalChartData.categories.indexOf("H-1") + 415,
                                    ...
                                    label: {
                                        ...
                                        offsetX: 205 // Geser sedikit ke kanan agar tidak nempel garis start
                                    }
                                },

                                // 2. PERIODE NATAL & TAHUN BARU (H s.d H+6)
                                {
                                    x: globalChartData.categories.indexOf("H")+460, 
                                    x2: globalChartData.categories.indexOf("H+6") + 955,
                                    ...
                                    label: {
                                        ...
                                        orientation: 'horizontal', // Teks Mendatar
                                        offsetY: 0, // Tempel di paling atas
                                        offsetX: 210 // Geser sedikit ke kanan agar tidak nempel garis start
                                    }
                                },
                                ...
                                {
                                    x: globalChartData.categories.indexOf("H+7")+1050, 
                                    ...
                                    label: {
                                        ...
                                        orientation: 'horizontal', // Teks Mendatar
                                        offsetY: 0, // Tempel di paling atas
                                        offsetX: 135 // Geser sedikit ke kanan agar tidak nempel garis start
                                    }
                                }
                            ]
                        },
