...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Pre Expire Warning Day Backups
    |--------------------------------------------------------------------------
    |
    | this value is used to determine the number of days before the expiration,
    | in case if in database setting table key (pre_expire_warning) is null.
    |
    */

    'pre_expire_warning' => env('PRE_EXPIRE_WARNING', 30),
